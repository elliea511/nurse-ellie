...
Cold-related emergencies occur when the body loses heat faster than it can produce heat.
...
High altitude sickness occurs because there is a lower partial pressure of oxygen at high elevations.

### Higher Risk Clients

* Obese clients
* Clients with chronic illness
* Clients with cardiovascular problems
...
High altitude sickness can progress to:
