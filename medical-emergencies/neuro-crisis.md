## layout: default title: Increased ICP and Hydrocephalus
...
Increased intracranial pressure, or increased ICP, means there is too much pressure inside the skull.

Think of the skull as a **rigid box**. It does not stretch like skin.

Inside the skull are:

- Brain tissue
- Blood
- Cerebrospinal fluid, or CSF

If any of these increase, pressure inside the skull rises.

## Causes

Increased ICP can occur from:
...
# Why Increased ICP Is Dangerous

Increased pressure can decrease blood flow and oxygen to the brain.
...
| ICP Value                                  | Meaning                    |
| ------------------------------------------ | -------------------------- |
| 0–15 mm Hg                                 | Normal ICP                 |
| 20 mm Hg or higher for more than 5 minutes | Life-threatening emergency |

------

# Recognize Increased ICP

## Earliest Sign

The earliest and most important sign is a **change in level of consciousness**.
...
Cushing’s triad is a **late sign** of increased ICP.

## Findings

| Finding                | What Happens                                        |
| ---------------------- | --------------------------------------------------- |
| Systolic hypertension  | Systolic BP increases                               |
| Widened pulse pressure | Difference between systolic and diastolic BP widens |
| Bradycardia            | Pulse decreases                                     |
| Respiratory depression | Respirations decrease or become abnormal            |

------

# Increased ICP vs Shock

| Finding          | Increased ICP                | Shock            |
| ---------------- | ---------------------------- | ---------------- |
| Blood pressure   | Systolic BP increases        | BP decreases     |
| Pulse            | Decreases                    | Increases        |
| Respirations     | Decrease or become irregular | Increase         |
| Priority concern | Brain pressure/perfusion     | Tissue perfusion |
...
| Disoriented        | Does not recognize place or person                 |
| Lethargic          | Awakens easily but has limited responsiveness      |
| Obtunded           | Sleeps and, once aroused, has limited interaction  |
...
You may not need to calculate the full score, but know what the ranges mean.
...
# Priority Assessment for Increased ICP
...
This helps promote venous drainage from the brain.
...
# What To Avoid With Increased ICP
...
| Excessive suctioning  | Can increase ICP           |
| Overstimulation       | Can worsen ICP             |
| Hip flexion           | Reduces venous drainage    |
| Neck flexion/rotation | Reduces venous drainage    |
| Tight collars or ties | Can restrict venous return |

------

# Medications and Treatments for Increased ICP

## Steroids

### Purpose

May decrease inflammation and swelling depending on cause.
...
Pulls fluid from the brain into the bloodstream so the kidneys can remove it.
...
Furosemide, or Lasix, may be used as a diuretic.
...
Hypertonic saline may be used to reduce ICP.
...
Fentanyl may be used for ventilated clients.

### Purpose

Helps control pain and decrease agitation.

------

## Barbiturate Coma

A barbiturate coma may be used when other interventions are unsuccessful.
...
| Device                          | Basic Point                                 |
| ------------------------------- | ------------------------------------------- |
| Intraventricular catheter       | Placed in ventricle; highest infection risk |
| Subarachnoid bolt or screw      | Measures pressure in one spot only          |
| Epidural sensor/transducer      | Less accurate because it is indirect        |
| Parenchymal fiberoptic catheter | Very accurate and reliable but expensive    |
...
Hydrocephalus is a buildup of cerebrospinal fluid, or CSF, in the brain.

This causes increased pressure on brain tissue.

## Basic CSF Flow

CSF normally flows through the ventricles and around the brain and spinal cord.

The brain has ventricles, including:

- Two lateral ventricles
- Third ventricle
- Fourth ventricle

CSF is made in the lateral ventricles and flows through connected passages. It eventually bathes the brain and spinal cord and is reabsorbed.

## What Goes Wrong

Hydrocephalus can occur when CSF flow is blocked, CSF is not absorbed properly, or too much CSF builds up.

A common cause is narrowing or blockage of the aqueduct of Sylvius.
...
Remove excess fluid from the brain and decrease pressure.

Treatment often includes a surgically placed shunt.
...
# Nursing Care After Shunt Placement
...
# Shunt Positioning Safety

## Do Not

- Do not place pressure on the shunt side.
- Do not position the infant directly on the side of the shunt unless ordered.
...
- Skin breakdown
- Compression of the shunt apparatus
- Shunt problems
...
| ------------------------- | ------------------------------------------------------------ |
| Increased ICP             | Too much pressure inside rigid skull                         |
| Skull contents            | Brain tissue, CSF, blood                                     |
| Earliest ICP sign         | Change in LOC                                                |
| Most important assessment | LOC                                                          |
| Normal ICP                | 0–15 mm Hg                                                   |
| Life-threatening ICP      | 20 mm Hg or higher for more than 5 minutes                   |
| Cushing’s triad           | Increased systolic BP/widened pulse pressure, bradycardia, respiratory depression |
| ICP vs shock              | Opposite vital sign pattern                                  |
| ICP positioning           | Semi-Fowler’s, head neutral midline                          |
| Avoid with ICP            | Straining, coughing, excessive suctioning, overstimulation   |
| PaO₂ goal                 | Keep above 80 mm Hg as ordered                               |
| Mannitol                  | Osmotic diuretic; monitor UOP/electrolytes                   |
| Hydrocephalus             | Excess CSF in brain                                          |
| Infant hydrocephalus      | Bulging fontanel, increased head circumference, high-pitched cry |
...
<div class="note">
<strong>Exam 3 Focus:</strong> For Exam 3, focus on <strong>TIA and Stroke</strong>. Increased ICP and Hydrocephalus are included in this section because they are closely related neurological emergency concepts and are commonly tested with changes in level of consciousness, neuro assessment, and priority interventions.
</div>

---

# Neurological Emergency Review Chart

| Emergency                | Main Problem                                   | Biggest Clues                                                                          | Priority Nursing Action                                               | Key Treatment                                                                           | NCLEX Tip                                            |
| ------------------------ | ---------------------------------------------- | -------------------------------------------------------------------------------------- | --------------------------------------------------------------------- | --------------------------------------------------------------------------------------- | ---------------------------------------------------- |
| **TIA**                  | Temporary decreased blood flow to the brain    | Sudden neuro symptoms that resolve, visual changes, weakness, numbness, speech changes | Treat seriously, assess neuro status, notify provider                 | Stroke prevention, antiplatelets/anticoagulants depending on cause, risk factor control | TIA is a warning sign of possible future stroke      |
| **Ischemic Stroke**      | Blood clot blocks blood flow to brain tissue   | Sudden focal neuro deficits, facial droop, arm weakness, speech difficulty             | Determine last known well, airway, CT scan, neuro checks              | Thrombolytics if eligible, antiplatelets, BP control, possible procedure                | CT must rule out hemorrhage before thrombolytics     |
| **Hemorrhagic Stroke**   | Bleeding in or around the brain                | Sudden severe headache, vomiting, decreased LOC, neuro deficits, very high BP          | Airway, neuro assessment, BP control, prepare for CT/surgery          | Control bleeding, BP meds, reverse anticoagulants, surgery if needed                    | Do not give thrombolytics for hemorrhagic stroke     |
| **Thrombolytic Therapy** | Medication breaks down clot in ischemic stroke | Ischemic stroke symptoms within time window and eligible criteria met                  | Confirm last known well, CT first, check bleeding risk                | rtPA/alteplase or ordered thrombolytic                                                  | “Time is brain”                                      |
| **Aspiration Risk**      | Stroke can impair swallowing/gag reflex        | Coughing with food, drooling, wet voice, dysphagia                                     | Keep NPO until swallow screen                                         | Thickened liquids or diet modifications if ordered                                      | No food, fluids, or PO meds until swallow is cleared |
| **Increased ICP**        | Too much pressure inside the skull             | Change in LOC, headache, vomiting, pupil changes                                       | Semi-Fowler’s, head midline, reduce stimulation, monitor neuro status | Mannitol, hypertonic saline, anticonvulsants, oxygenation support                       | Earliest sign is change in LOC                       |
| **Cushing’s Triad**      | Late sign of increased ICP                     | Increased systolic BP/widened pulse pressure, bradycardia, abnormal respirations       | Report immediately                                                    | Treat increased ICP                                                                     | Late sign = very serious                             |
| **Hydrocephalus**        | Excess CSF in brain                            | Infant: bulging fontanel, increased head circumference, high-pitched cry               | Monitor LOC, head circumference, fontanels, shunt signs               | VP or VA shunt                                                                          | Think CSF buildup                                    |
| **Shunt Malfunction**    | Shunt not draining CSF properly                | Return of symptoms, vomiting, bulging fontanel, decreased LOC                          | Report immediately                                                    | Shunt evaluation/revision if needed                                                     | Looks like increased ICP returning                   |
| **Shunt Infection**      | Infection after shunt placement                | Fever, redness, swelling, drainage, irritability, neck stiffness                       | Report immediately, monitor incision                                  | Antibiotics as ordered                                                                  | Fever after shunt is concerning                      |
...
* Sudden motor changes
* Facial drooping

## NCLEX Tip

Even if symptoms go away, a TIA is not “nothing.”

It should be treated as a warning sign that the client is at risk for stroke.
...
| Brain Damage       | Expected Finding     |
| ------------------ | -------------------- |
| Left brain damage  | Right-sided weakness |
| Right brain damage | Left-sided weakness  |
...
Do not give thrombolytics until bleeding has been ruled out.
...
* Aspiration precautions due to dysphagia
* Monitor vital signs
* Obtain baseline PT/INR and aPTT
* Start two IV lines with normal saline
* Monitor for increased ICP
* Hyperoxygenate before suctioning
* Keep HOB at or greater than 30°
* Decrease environmental stimulation
* Avoid clustering procedures because too much activity can increase ICP
...
| Clue                                       | Think                                     |
| ------------------------------------------ | ----------------------------------------- |
| Sudden facial droop                        | Stroke                                    |
| Sudden arm weakness                        | Stroke                                    |
| Sudden speech difficulty                   | Stroke                                    |
| Symptoms resolved quickly                  | TIA                                       |
| TIA symptoms went away                     | Still a warning sign                      |
| Woke up with symptoms                      | Last known well may be bedtime            |
| Severe headache + vomiting + decreased LOC | Possible hemorrhagic stroke/increased ICP |
| Atrial fibrillation history                | Embolic stroke risk                       |
| CT scan before rtPA                        | Rule out hemorrhage                       |
| No swallow screen yet                      | Keep NPO                                  |
| Wet voice after drinking                   | Aspiration risk                           |
...
Assess airway and keep NPO until swallow screen is completed.

## Sudden Neuro Symptoms That Resolve

Treat as TIA and warning sign.

## Signs of Increased ICP

Report worsening neuro changes immediately.
...
| Topic                     | What To Remember                                                                  |
| ------------------------- | --------------------------------------------------------------------------------- |
| TIA                       | Temporary neuro symptoms that resolve; warning sign for stroke                    |
| Stroke                    | Sudden focal neurological symptoms                                                |
| Ischemic stroke           | Blockage/interruption of blood flow                                               |
| Hemorrhagic stroke        | Bleeding in or around brain                                                       |
| Last known well           | Priority question for suspected stroke                                            |
| CT before thrombolytics   | Rule out hemorrhage first                                                         |
| Swallow screen            | Keep NPO until cleared                                                            |
| Increased ICP             | Too much pressure inside rigid skull                                              |
| Skull contents            | Brain tissue, CSF, blood                                                          |
| Earliest ICP sign         | Change in LOC                                                                     |
| Most important assessment | LOC                                                                               |
