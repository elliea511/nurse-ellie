...
<style>
  ...
  .renal-hero {
    ...
    margin: 0 auto;
    padding: clamp(.7rem, 1.5vh, 1rem) clamp(1.2rem, 4vw, 4.2rem) .8rem;
  }
  ...
  .renal-title h1 {
    ...
    font-size: clamp(3.6rem, 5.9vw, 5.65rem) !important;
  ...
  .renal-topic-card {
    ...
    box-shadow: 0 14px 30px rgba(43, 82, 126, .13), inset 0 1px 0 rgba(255,255,255,.88);
