...
<h3>Osteoarthritis & Gout Big Picture</h3>
...
<div class="page-nav">
  <a href="{{ '/immune-inflammatory/rheumatoid-arthritis.html' | relative_url }}" class="page-nav-back">← Rheumatoid Arthritis</a>
  <a href="{{ '/immune-inflammatory/systemic-lupus-erythematosus.html' | relative_url }}" class="page-nav-next">Systemic Lupus Erythematosus →</a>
</div>
