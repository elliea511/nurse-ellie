...
<div class="page-nav">
  <a href="{{ '/immune-inflammatory/osteoarthritis-gout.html' | relative_url }}" class="page-nav-back">← Osteoarthritis & Gout</a>
  <a href="{{ '/immune-inflammatory/antimicrobials.html' | relative_url }}" class="page-nav-next">Antimicrobials →</a>
</div>
