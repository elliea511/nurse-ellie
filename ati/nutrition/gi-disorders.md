...
- [Gastric Bypass / Bariatric Surgery](#bariatric)
...
<h3 id="big-picture">Big Picture: Matching Condition to Strategy</h3>
...
|---|---|
| Heartburn, regurgitation, worse when lying down | GERD — avoid LES-relaxing and irritating foods |
| Epigastric pain + tarry stools + anemia | PUD with possible GI bleeding — priority finding |
