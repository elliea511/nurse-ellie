...
<h3 id="big-picture">Big Picture: GI Tract vs. Bloodstream</h3>

| Type | Route | Used When |
|---|---|---|
...
<h3 id="gi-complications">Other GI Complications: Matching Symptom to Mechanism and Fix</h3>

This is one of the most heavily tested patterns in this whole section — ATI frequently builds questions where several plausible-sounding fixes are offered, and only one matches the *specific* symptom described. Knowing the mechanism behind each fix is what lets you eliminate the wrong answers instead of guessing.
...
| **Abdominal distention/bloating** | Fat slows gastric emptying — formula sits longer, increasing fullness | Lower-fat formula |
| **Nausea/vomiting** | Often reflects temporary lactose intolerance from illness-related changes to the GI mucosa, or delayed emptying | Lactose-free formula |
...
<h3 id="refeeding">Refeeding Syndrome</h3>
...
<h3 id="parenteral">Parenteral Nutrition</h3>
...
<h3 id="tpn-glucose">TPN Glucose Complications</h3>

TPN's high dextrose concentration cuts both ways.
...
| Diarrhea (not improving with slower rate) | Consider contaminated/expired formula or sorbitol-based liquid meds/antibiotics | Check hang time; review medication list |
| Abdominal distention/bloating | Fat slows gastric emptying | Lower-fat formula |
| Nausea/vomiting | Often temporary lactose intolerance or delayed emptying | Lactose-free formula |
...
|---|---|---|
| Phosphate | Drops sharply | Most dangerous — cardiac/respiratory muscle failure risk |
...
| Diarrhea not resolving despite slower rate | Check formula hang time/contamination and review for sorbitol-based meds or antibiotics |
| Bloating/distention during tube feeding | Lower-fat formula (fat slows gastric emptying) |
| Nausea/vomiting during tube feeding | Lactose-free formula (often temporary lactose intolerance) |
| Constipation during tube feeding | Increase free water (formula is calorie-dense, water-poor) |
| Cramping during tube feeding | Warm formula to room temperature; consider rate |
| High urine specific gravity in a tube-fed client | Dehydration — add free water; consider lower-protein formula |
| Flushing before/after tube meds | 30–50 mL water |
| Flushing an unused tube | ~1.5x the normal flush volume |
| Enteric-coated or extended-release medication + feeding tube | Do not crush — use liquid form |
| Transitioning tube feeding to oral intake | Hold feeding ~1 hr before meals; shift to nighttime-only once oral intake covers 500–750 kcal/day |
| Removing a feeding tube | Only after oral intake is **reliably** sustained over time, not just hit once; swallowing safety confirmed |
| Severely malnourished client starting nutrition support | Start slow — refeeding syndrome risk |
...
| TPN stopped abruptly | Monitor for hypoglycemia; hang dextrose solution if next bag isn't ready |
| TPN + low magnesium | Expected electrolyte shift risk |
| TPN lipid emulsion + egg allergy | Report before administration |
| Discontinuing TPN | Oral/enteral intake exceeds 60% of estimated needs, **sustained** — not stopped abruptly |
| How TPN is actually weaned off | Gradual rate taper as oral/enteral intake rises — same "overlap, don't swap" principle as enteral-to-oral |
