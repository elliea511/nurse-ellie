...
Macronutrients are nutrients the body needs in larger amounts. They provide energy and support growth, healing, and normal body function.

| Macronutrient | Main Purpose | ATI Notes |
|---|---|---|
| **Carbohydrates** | Primary energy source | Affect blood glucose levels. Simple sugars are usually limited in diabetes and dumping syndrome. |
| **Protein** | Tissue repair, immune function, muscle maintenance, wound healing | Increased need with wounds, infection, burns, surgery, cancer, pregnancy, older adults, and COPD. |
| **Fat** | Energy, insulation, hormone support, absorption of fat-soluble vitamins | High-fat foods may be limited in certain conditions, but fat is still needed for normal function. |

---

## Protein

Protein is needed for tissue repair, immune function, muscle strength, and wound healing.
...
Protein needs increase when the body is trying to heal, fight infection, or maintain muscle mass.
...
Micronutrients are vitamins and minerals needed in smaller amounts. They do not provide calories, but they are necessary for normal body function.

| Type | Examples | Key ATI Focus |
|---|---|---|
| **Vitamins** | A, B-complex, C, D, E, K | Vision, healing, clotting, calcium absorption, anemia prevention |
| **Minerals** | Calcium, magnesium, potassium, phosphorus, iron | Bones, electrolytes, cardiac function, anemia prevention |

---

## Fat-Soluble vs. Water-Soluble Vitamins

| Type | Vitamins | Main ATI Point |
|---|---|---|
| **Fat-soluble** | Vitamins **A, D, E, K** | Stored in the body. Higher risk for toxicity. |
...
| Function | ATI Notes |
|---|---|
| **Night vision** | Helps the eyes adapt to dim lighting. |
| **Skin and mucous membranes** | Supports tissue integrity. |
...
Lutein is a carotenoid related to vitamin A.

| Function | ATI Notes |
|---|---|
| Eye health | Can slow the progression of age-related macular degeneration. |
...
Vitamin B6 helps with heme formation and neurotransmitter synthesis.

| Function | ATI Notes |
|---|---|
| Heme formation | Helps form hemoglobin components. |
...
Folate is important for red blood cell formation and pregnancy.

| Function | ATI Notes |
|---|---|
| RBC formation | Helps prevent certain types of anemia. |
| Pregnancy | Helps reduce risk for neural tube defects. |
...
Vitamin C supports wound healing and improves iron absorption.

| Function | ATI Notes |
|---|---|
| Wound healing | Helps collagen formation. |
| Iron absorption | Helps the body absorb non-heme iron. |
| Immune support | Supports normal immune function. |
...
| Function | ATI Notes |
|---|---|
| Calcium absorption | Needed for bone health. |
| Older adults | Older adults often need supplementation because they have decreased ability to synthesize vitamin D from sunlight. |

**Common older adult teaching:**

- Vitamin D supplementation may be recommended.
- A common range is **1,000 to 2,000 IU/day**, depending on the provider’s recommendation.
...
| Function | ATI Notes |
|---|---|
| Clotting | Helps the body form clotting factors. |
| Warfarin interaction | Clients taking warfarin should keep vitamin K intake consistent. |
...
| Nerve transmission | Helps with nerve signaling. |
...
| Function | ATI Notes |
|---|---|
| Muscle and nerve function | Helps maintain normal neuromuscular function. |
...
Potassium is important for heart rhythm, muscle function, and fluid balance.

| Function | ATI Notes |
|---|---|
| Cardiac rhythm | Abnormal potassium can cause dysrhythmias. |
| Muscle function | Low or high potassium can cause weakness. |
| Blood pressure | Potassium can help decrease blood pressure in some clients. |
...
| Function | ATI Notes |
|---|---|
| Bone and teeth formation | Works with calcium for bone health. |
...
Iron is needed to form hemoglobin and prevent iron-deficiency anemia.

| Function | ATI Notes |
|---|---|
| Hemoglobin formation | Helps carry oxygen in the blood. |
| Pregnancy | Pregnant clients usually need iron supplementation. |
| Anemia prevention | Low iron can cause fatigue, pallor, weakness, and low hemoglobin. |

**Pregnancy ATI note:**

- Pregnant clients should take **30 mg of iron daily** to reduce the risk for iron-deficiency anemia.

**Teaching tips:**

- Take iron with vitamin C to improve absorption.
- Liquid iron can stain teeth, so use a straw if needed.
- Iron can cause constipation and dark stools.
...
Albumin is a protein made by the liver. It can help reflect long-term protein status, but it can also be affected by inflammation, liver disease, kidney disease, and fluid status.

| Lab | What It Can Suggest |
|---|---|
| **Low albumin** | Possible malnutrition, inflammation, liver disease, kidney disease, or fluid imbalance |

---

### Prealbumin

Prealbumin is often used to evaluate more recent changes in nutritional status.
...
Malnutrition can occur when the body does not get enough calories, protein, vitamins, or minerals.

| Finding | Possible Meaning |
|---|---|
| **Lower extremity edema** | Can indicate protein deficiency. |
| **Dry skin** | Can be a sign of malnutrition. |
| **Dry conjunctiva** | Can be a sign of vitamin or nutritional deficiency. |
| **Corneal vascularization** | Can be associated with malnutrition. |
| **Paresthesia** | Can indicate vitamin deficiency or malnutrition. |
| **Weak hand grasps** | Can indicate muscle wasting or malnutrition. |
| **Poor wound healing** | Can indicate inadequate protein or vitamin C. |
| **Weight loss** | Can indicate inadequate intake or illness. |
...
Severe malnutrition can affect skin, muscles, immune function, wound healing, and fluid balance.
...
- Monitor albumin and prealbumin if ordered.
- Monitor edema.
...
Fluid volume deficit can occur from vomiting, diarrhea, fever, sweating, poor intake, or excessive fluid loss.
...
|---|---|
| Dry mucous membranes | Decreased body fluid |
| Poor skin turgor | Dehydration |
| Tachycardia | Compensation for low volume |
| Hypotension | Low circulating volume |
...
| Weight gain | Early sign of fluid retention |
| Bounding pulses | Increased circulating volume |
| Hypertension | Increased vascular volume |

---

## Fluid Deficit vs. Fluid Overload

| Finding | Fluid Volume Deficit | Fluid Volume Excess |
|---|---|---|
| Weight | Loss | Gain |
| Heart rate | Often increased | May be increased |
| Blood pressure | Low or orthostatic | High |
| Skin | Dry, poor turgor | Edema |
| Lungs | Usually clear | Crackles possible |
| Urine | Dark, decreased | May be increased or decreased depending on cause |

---

## Weight Loss Teaching

Healthy weight loss should be realistic and sustainable.

| Teaching | Rationale |
|---|---|
| Lose **0.5 to 1 lb per week** | Realistic and helps prevent nutritional deficiencies. |
| Use a shopping list | Helps with meal planning and prevents impulse buying. |
| Eat low-calorie foods first | Helps with portion control and fullness. |
| Eat regular meals | Helps prevent extreme hunger and overeating. |
| Avoid tasting foods while cooking | Helps prevent extra calorie intake. |
| Control portion sizes | More sustainable than completely restricting favorite foods. |

---

## Healthy Eating Teaching

General healthy eating focuses on balance, portion control, and nutrient-dense foods.
...
- Use portion control rather than extreme restriction.
...
### Think Malnutrition If the Client Has:
...
### Think Fluid Volume Deficit If the Client Has:
...
### Think Fluid Volume Excess If the Client Has:
...
- If the question asks about **warfarin**, think **consistent vitamin K intake**.
- If the question mentions **ACE inhibitors**, watch for **hyperkalemia** and high-potassium foods.
- If the question mentions **vomiting and diarrhea**, think **fluid volume deficit and electrolyte imbalance**.
