...
## High-Yield Lab Connections

| Situation | Labs to Think Of |
|---|---|
| **Preeclampsia** | Urine protein, platelets, AST/ALT, creatinine, LDH, uric acid |
| **HELLP** | LDH/hemolysis labs, AST/ALT, platelets |
| **Rh-negative mother** | Rh factor, antibody screen, baby blood type, direct Coombs, Kleihauer-Betke |
| **Positive GBS** | GBS swab, intrapartum antibiotics |
| **Gestational diabetes** | 1-hour glucose screen, 3-hour GTT, newborn glucose |
| **Postpartum hemorrhage** | Hgb, Hct, platelets, blood type/crossmatch |
| **Newborn jaundice** | Bilirubin, direct Coombs, blood type |
| **Newborn jitteriness** | Blood glucose |
| **ROM suspected** | Nitrazine test, fern test |
| **Postpartum infection** | WBC plus symptoms: fever, foul-smelling lochia, uterine tenderness, chills, tachycardia |

---

## Lab Value Disclaimer

Lab values can vary slightly by facility, textbook, pregnancy status, gestational age, and newborn age in hours. For exams, use these as **general nursing rules**, but always follow the reference range given in the question, facility policy, or provider order.
