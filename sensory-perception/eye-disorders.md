...
<div class="mh-breadcrumb">
  <a href="{{ '/sensory-perception.html' | relative_url }}">Sensory Perception</a>
  <span>Eye Disorders</span>
</div>

# Eye Disorders

<p class="mh-subtitle">PN-level review of eye assessment, conjunctivitis, cataracts, glaucoma, retinal disorders, eye trauma, medications, and visual-impairment safety</p>

Eye disorders can affect the client’s ability to see clearly, move safely, administer medications, and complete activities of daily living. Nursing priorities include **protecting vision, recognizing sudden vision changes, preventing injury, administering eye medications correctly, and teaching postoperative precautions.**

<div class="priority-focus">
  <div>
    <h3>Priority Focus</h3>
    Sudden Vision Loss • Eye Pain • Increased Intraocular Pressure • Retinal Detachment • Infection Prevention • Medication Safety • Fall Prevention
  </div>
</div>
...
| Assessment | Purpose |
|---|---|
| **Visual acuity** | Measures clarity of central vision |
| **Pupillary response** | Evaluates response to light and neurologic function |
| **Extraocular movements** | Evaluates eye-muscle movement |
| **Visual fields** | Identifies loss of peripheral vision |
...
|---|---|---|
| **Bacterial** | Purulent or yellow-green drainage; eyelids may be stuck together in the morning | Antibiotic drops or ointment as ordered; prevent spread |
| **Viral** | Watery drainage; often occurs with an upper respiratory infection | Symptom relief, hygiene, avoid spreading infection |
| **Allergic** | Intense itching, tearing, bilateral redness | Avoid allergen; antihistamine or mast-cell stabilizer drops |
...
| Usually painless | Severe pain |
| Peripheral vision lost first | Rapid blurred vision |
...
|---|---|---|
| **Prostaglandin analogs** | Latanoprost | May darken iris and increase eyelash growth |
| **Beta blockers** | Timolol | Can lower heart rate and blood pressure; use caution with asthma |
...
1. Begin irrigation immediately.
2. Do not delay irrigation to complete a detailed assessment.
3. Use water or prescribed irrigating solution.
4. Remove contact lenses when possible.
...
4. Ask the client to look upward.
5. Pull the lower lid down to form a conjunctival sac.
6. Instill drops into the conjunctival sac.
7. Do not place drops directly on the cornea.
8. Do not touch the dropper to the eye.
...
|---|---|---|
| **Conjunctivitis** | Redness and drainage | Prevent spread and treat cause |
| **Cataract** | Gradual painless cloudy vision | Surgical teaching and postoperative protection |
| **Open-angle glaucoma** | Gradual peripheral-vision loss | Lifelong pressure-lowering drops |
| **Angle-closure glaucoma** | Severe pain, halos, nausea | Emergency treatment |
| **Retinal detachment** | Flashes, floaters, curtain | Immediate ophthalmology care |
| **Macular degeneration** | Central-vision loss | Safety and low-vision support |
...
3. Cataracts cause gradual painless cloudy vision.
4. Avoid bending, lifting, and straining after cataract surgery.
5. Open-angle glaucoma is gradual and painless.
6. Angle-closure glaucoma is painful and emergent.
7. Retinal detachment causes flashes, floaters, and curtain-like vision.
8. Macular degeneration affects central vision.
9. Irrigate a chemical eye injury immediately.
10. Instill eye drops into the conjunctival sac.
11. Use drops before ointment.
...
- Do not stop glaucoma drops because symptoms are absent.
- Do not ignore painless flashes or floaters.
- Do not apply pressure to a penetrating eye injury.
...
<div class="cheer-banner">
  Eye-disorder questions are mostly about recognizing emergencies: sudden vision loss, severe pain, flashes, floaters, a curtain over vision, or chemical and penetrating injuries.
</div>

---

<div class="page-nav">
  <a href="{{ '/sensory-perception.html' | relative_url }}" class="page-nav-back">← Sensory Perception Hub</a>
  <a href="{{ '/sensory-perception/ear-disorders.html' | relative_url }}" class="page-nav-next">Ear Disorders →</a>
</div>
