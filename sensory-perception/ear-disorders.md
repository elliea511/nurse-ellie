...
<div class="mh-breadcrumb">
  ...
  <span>Ear Disorders</span>
</div>

# Ear Disorders

<p class="mh-subtitle">PN-level review of hearing loss, otitis media, labyrinthitis, Ménière disease, otosclerosis, ear trauma, medications, procedures, and hearing-impaired care</p>

Ear disorders may affect **hearing, balance, communication, mobility, and safety**. Nursing priorities include recognizing infection, preventing falls during vertigo, protecting hearing, administering ear medications correctly, and identifying sudden hearing loss or drainage that requires immediate evaluation.

<div class="priority-focus">
  <div>
    <h3>Priority Focus</h3>
    Hearing Changes • Infection • Vertigo • Fall Prevention • Ear Drainage • Medication Administration • Communication Safety
  </div>
</div>
...
|---|---|---|
| **External ear** | Pinna and ear canal | Collects and directs sound |
...
|---|---|
| Problem in external or middle ear | Problem in inner ear or auditory nerve |
| Sound may seem muffled | Speech may sound distorted |
| Client may speak softly | Client may speak loudly |
...
| Test | Purpose |
|---|---|
| **Otoscopy** | Examines the ear canal and tympanic membrane |
| **Audiometry** | Measures hearing ability at different tones and volumes |
| **Tympanometry** | Evaluates middle-ear pressure and tympanic-membrane movement |
...
3. Straighten the ear canal correctly.
4. Instill drops along the side of the canal.
5. Do not touch the dropper to the ear.
6. Gently press the tragus if appropriate.
...
|---|---|---|
| **Acute otitis media** | Ear pain, fever, bulging tympanic membrane | Pain relief, infection treatment, monitor hearing |
| **Otitis media with effusion** | Fluid and muffled hearing without acute illness | Monitor hearing and speech development |
| **Labyrinthitis** | Vertigo, tinnitus, hearing loss, nystagmus | Fall prevention and symptom control |
| **Ménière disease** | Episodic vertigo, tinnitus, hearing loss, ear fullness | Safety during attacks and low-sodium teaching |
| **Otosclerosis** | Gradual conductive hearing loss | Hearing support or stapes surgery |
| **Ototoxicity** | Tinnitus or new hearing change after medication | Report medication toxicity |
...
- Severe vertigo with weakness, speech changes, or facial droop
- Button battery in the ear
- Swelling behind the ear
- Absent improvement with worsening fever
- New tinnitus after an ototoxic medication
- Facial weakness after ear surgery
...
3. Acute otitis media causes pain, fever, and a bulging tympanic membrane.
4. Persistent middle-ear fluid can delay hearing and speech development.
5. Labyrinthitis causes vertigo, tinnitus, hearing loss, and nystagmus.
6. Ménière disease causes vertigo, tinnitus, fluctuating hearing loss, and ear fullness.
7. Otosclerosis causes gradual conductive hearing loss.
8. Prevent straining and pressure changes after stapes surgery.
9. Do not irrigate beans, seeds, or button batteries.
10. Tinnitus may indicate ototoxicity.
11. Pull the adult ear up and back.
12. Pull the young child’s ear down and back.
13. Keep the client on the unaffected side after administering drops.
...
- Do not walk a client with active vertigo without assistance.
- Do not irrigate an ear with a suspected perforation.
- Do not pack clear or bloody drainage after head trauma.
- Do not insert objects deeply into the ear canal.
...
<div class="cheer-banner">
  Ear-disorder questions usually come down to infection, balance, hearing protection, and safety. Watch for vertigo, sudden hearing changes, abnormal drainage, and signs of ototoxicity.
</div>

---

<div class="page-nav">
  <a href="{{ '/sensory-perception/eye-disorders.html' | relative_url }}" class="page-nav-back">← Eye Disorders</a>
  <a href="{{ '/sensory-perception.html' | relative_url }}" class="page-nav-next">Sensory Perception Hub →</a>
</div>
