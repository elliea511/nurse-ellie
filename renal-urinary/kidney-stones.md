...
<p class="mh-subtitle">PN-level review of stone types, renal and ureteral pain, obstruction, diagnostics, treatment, dietary teaching, procedures, and priority nursing care</p>

**Kidney stones**, also called **renal calculi or urolithiasis**, are hard deposits that form when minerals and other substances become concentrated and crystallize in the urinary tract. Stones can remain in the kidney or move into the ureter, bladder, or urethra.

Small stones may pass without a procedure. Larger stones, obstructing stones, infected stones, or stones causing uncontrolled pain may require removal.

<div class="priority-focus">
  <div>
    <h3>Priority Focus</h3>
    Severe Pain • Urinary Obstruction • Infection • Hydration • Strain Urine • Identify Stone Type • Protect Kidney Function
  </div>
</div>
...
<div class="mh-cards">
  ...
  <div class="mh-card blue">
    ...
    <h3>Stone Types</h3>
    <p>Calcium oxalate, uric acid, struvite, cystine, causes, and prevention teaching.</p>
    <a class="mh-btn" href="#panel-stone-types">Study Stone Types</a>
  </div>

  <div class="mh-card green">
    <div class="mh-card-icon">⚡</div>
    <h3>Assessment & Pain</h3>
    <p>Renal colic, ureteral colic, hematuria, obstruction, infection, and complications.</p>
  ...
  <div class="mh-card pink">
    ...
    <p>Fluids, pain control, straining urine, medications, mobility, and diet changes.</p>
    <a class="mh-btn" href="#panel-treatment">Study Treatment</a>
  </div>

  <div class="mh-card purple">
    <div class="mh-card-icon">🏥</div>
    <h3>Stone Procedures</h3>
    <p>Shock-wave lithotripsy, ureteroscopy, nephrolithotomy, stents, and nephrostomy care.</p>
    <a class="mh-btn" href="#panel-procedures">Study Procedures</a>
  </div>

</div>

<div class="mh-detail blue" id="panel-stone-types" markdown="1">
...
<div class="mh-detail green" id="panel-assessment" markdown="1">
<a class="mh-detail-close" href="#">✕</a>
...
* Pain occurs in the flank or costovertebral area.
...
* Pain may radiate from the flank toward the groin.
* May radiate to the scrotum, penis, vulva, or vaginal area.
...
4. Collect all urine for the next 24 hours.
5. Include the final void at the ending time.
6. Keep the specimen refrigerated or on ice according to laboratory policy.
7. Restart the collection if urine is missed, according to policy.
...
<div class="mh-detail purple" id="panel-procedures" markdown="1">
<a class="mh-detail-close" href="#">✕</a>
...
* Obtain prescribed labs and imaging.
...
* Notify the provider if output suddenly stops.
...
<h3>📋 Kidney Stones Big Picture</h3>

* Calcium oxalate stones are the most common.
* Uric acid stones are associated with gout, acidic urine, dehydration, and excess purines.
* Struvite stones are associated with urinary infections.
* Cystine stones are caused by an inherited disorder.
* Severe wave-like pain occurs when the ureter contracts around a moving stone.
* Hematuria is common.
* Obstruction can cause hydronephrosis and kidney damage.
* Infection behind an obstruction can lead to sepsis.
* Control pain, maintain prescribed fluids, and strain all urine.
* Stone analysis determines long-term prevention teaching.
* Large or obstructing stones may require ESWL, ureteroscopy, or nephrolithotomy.
...
* Hypotension or new confusion
* Anuria
* Sudden decrease in urine output
* Uncontrolled pain
* Persistent vomiting
* Heavy bright-red bleeding
* Inability to urinate after a procedure
* Nephrostomy tube stops draining
* Nephrostomy or stent displacement
...
Pain is expected with kidney stones, but **pain plus fever, oliguria, anuria, or hypotension** suggests obstruction, infection, or impaired kidney function and becomes the priority.
...
| **Renal colic**     | Deep flank pain from a stone near the kidney                 |
| **Ureteral colic**  | Severe wave-like pain from a stone moving through the ureter |
| **Hematuria**       | Blood in the urine                                           |
| **Hydronephrosis**  | Swelling of the kidney from backed-up urine                  |
| **Hypercalciuria**  | Excess calcium in the urine                                  |
| **Hyperuricemia**   | Excess uric acid in the blood                                |
| **Oxalate**         | Substance that can combine with calcium to form stones       |
| **Purines**         | Substances broken down into uric acid                        |
| **ESWL**            | Shock waves break a stone into passable fragments            |
| **Ureteroscopy**    | Scope enters the urinary tract to remove or break a stone    |
| **Nephrolithotomy** | Stone removed through an incision into the kidney            |
| **Ureteral stent**  | Tube keeps the ureter open                                   |
...
2. Uric acid stones are associated with gout and purines.
3. Struvite stones are associated with UTIs.
4. Cystine stones are inherited.
5. Ureteral stones cause sharp, wave-like pain radiating toward the groin.
6. Strain all urine and save the stone.
7. Encourage prescribed fluids unless obstruction or a fluid restriction is present.
8. Fever plus stone pain is an emergency warning.
9. ESWL breaks stones, but fragments still need to pass.
10. Monitor nephrostomy tubes for continuous drainage.
...
* Do not ignore fever or chills with a kidney stone.
* Do not automatically restrict all dietary calcium.
* Do not force fluids into a client with complete obstruction.
* Do not forget to strain urine.
* Do not discard a passed stone.
* Do not clamp or irrigate a nephrostomy tube without an order.
* Do not miss stent-removal follow-up.
* Do not treat all stones with the same diet.
* Do not confuse expected mild hematuria with heavy persistent bleeding.
...
<div class="cheer-banner">
  💚 Kidney-stone questions are mostly pain + obstruction + infection questions. Control the pain, watch the urine output, strain the urine, and never ignore fever. 💚
</div>

---

<div class="page-nav">
  <a href="{{ '/renal-urinary/urinary-tract-infections.html' | relative_url }}" class="page-nav-back">← Urinary Tract Infections</a>
  <a href="{{ '/renal-urinary/glomerulonephritis.html' | relative_url }}" class="page-nav-next">Glomerulonephritis →</a>
</div>
