---
layout: default
title: Dialysis, Transplant & Urinary Procedures
---

<div class="mh-breadcrumb">
  <a href="{{ '/renal-urinary.html' | relative_url }}">Renal & Urinary</a>
  <span>Dialysis, Transplant & Urinary Procedures</span>
</div>

# Dialysis, Transplant & Urinary Procedures

<p class="mh-subtitle">PN-level review of hemodialysis, peritoneal dialysis, kidney transplant, renal diagnostics, urinary surgery, and urinary diversions</p>

When the kidneys cannot adequately remove **fluid, electrolytes, acids, and metabolic wastes**, the client may require dialysis or kidney transplantation. Other clients may require urinary procedures or diversions because of obstruction, cancer, injury, or removal of the bladder.

<div class="priority-focus">
  <div>
    <h3>Priority Focus</h3>
    Fluid Balance • Access Patency • Infection Prevention • Bleeding • Cloudy Dialysate • Rejection • Urine Output • Stoma Care
  </div>
</div>
...
<div class="mh-cards">
  ...
  <div class="mh-card blue">
    ...
    <h3>Hemodialysis</h3>
    <p>Vascular access, thrill and bruit, pre- and post-dialysis care, and complications.</p>
    <a class="mh-btn" href="#panel-hemodialysis">Study Hemodialysis</a>
  </div>

  <div class="mh-card green">
    <div class="mh-card-icon">💧</div>
    <h3>Peritoneal Dialysis</h3>
    <p>Inflow, dwell, drainage, cloudy effluent, peritonitis, and catheter care.</p>
    <a class="mh-btn" href="#panel-peritoneal">Study Peritoneal Dialysis</a>
  </div>

  <div class="mh-card pink">
    <div class="mh-card-icon">🫘</div>
    <h3>Kidney Transplant</h3>
    <p>Donor matching, postoperative care, immunosuppressants, rejection, and infection risk.</p>
    <a class="mh-btn" href="#panel-transplant">Study Kidney Transplant</a>
  </div>

  <div class="mh-card purple">
    <div class="mh-card-icon">🧪</div>
    <h3>Renal Diagnostics</h3>
    <p>Urine testing, kidney-function labs, contrast studies, cystoscopy, and catheterization.</p>
    <a class="mh-btn" href="#panel-diagnostics">Study Diagnostics</a>
  </div>

  <div class="mh-card blue">
    <div class="mh-card-icon">🚻</div>
    <h3>Urinary Diversions</h3>
    <p>Ileal conduit, Indiana pouch, ureterosigmoidostomy, stoma care, and patient teaching.</p>
    <a class="mh-btn" href="#panel-diversions">Study Diversions</a>
  </div>

</div>

<div class="mh-detail blue" id="panel-hemodialysis" markdown="1">
...
* Absent thrill
* Absent bruit
* Sudden change in the access
* Cool or pale access extremity
* Severe hand pain or numbness
...
<div class="mh-detail green" id="panel-peritoneal" markdown="1">
<a class="mh-detail-close" href="#">✕</a>
...
* The bag is positioned above the abdomen.
...
* Dwell time depends on the prescribed therapy.
...
* Output should generally equal or exceed inflow.
...
If used dialysate is cloudy:

1. Do not discard the drainage.
2. Save the bag or obtain a specimen as directed.
3. Notify the provider or dialysis team.
4. Assess temperature and abdominal pain.
5. Anticipate culture and antibiotic therapy.
...
<div class="mh-detail pink" id="panel-transplant" markdown="1">
<a class="mh-detail-close" href="#">✕</a>
...
<div class="mh-detail purple" id="panel-diagnostics" markdown="1">
<a class="mh-detail-close" href="#">✕</a>
...
* Never inflate the balloon before urine return and proper placement.
...
<div class="mh-detail blue" id="panel-diversions" markdown="1">
<a class="mh-detail-close" href="#">✕</a>
...
* Mucus in urine
* Temporary mild hematuria after surgery
...
<h3>📋 Dialysis, Transplant & Procedures Big Picture</h3>

* Hemodialysis filters the blood through a machine.
* Peritoneal dialysis uses the peritoneal membrane.
* Feel for a thrill and listen for a bruit over a fistula or graft.
* Never use the access arm for blood pressure, venipuncture, or routine IV therapy.
* Hemodialysis can cause hypotension, cramps, bleeding, and access problems.
* Cloudy peritoneal effluent suggests peritonitis.
* Reposition the client and check tubing when peritoneal drainage is slow.
* Kidney-transplant clients require lifelong immunosuppression.
* Rising creatinine and falling urine output may indicate graft dysfunction or rejection.
* An ileal conduit drains continuously into an external pouch.
* Mucus is expected because intestinal tissue forms the conduit.
* A healthy stoma is moist and pink to red.
...
* New neurologic changes during dialysis
* Cloudy peritoneal dialysate
* Abdominal pain and fever
* Rising transplant creatinine
* Reduced transplant urine output
* Fever while immunosuppressed
* Dusky or black urinary stoma
* No urine drainage
...
Match each emergency to the therapy:

* **Hemodialysis:** absent thrill, hypotension, bleeding
* **Peritoneal dialysis:** cloudy drainage, abdominal pain
* **Transplant:** rising creatinine, reduced urine, infection
* **Urinary diversion:** dark stoma, no drainage, skin breakdown
...
<h3>Hemodialysis vs. Peritoneal Dialysis</h3>

| Feature                     | Hemodialysis                        | Peritoneal Dialysis                 |
| --------------------------- | ----------------------------------- | ----------------------------------- |
| **Filter**                  | Artificial dialyzer                 | Peritoneal membrane                 |
| **Access**                  | Fistula, graft, or catheter         | Abdominal catheter                  |
| **Major infection concern** | Vascular access infection           | Peritonitis                         |
| **Major assessment cue**    | Thrill and bruit                    | Clear effluent                      |
| **Common complication**     | Hypotension                         | Peritonitis                         |
| **Protein loss**            | Some loss possible                  | Greater protein loss                |
| **Anticoagulation**         | Often used during treatment         | Usually no systemic heparin         |
| **Location**                | Center or home                      | Often home                          |
| **Priority emergency**      | Absent thrill or severe hypotension | Cloudy effluent with abdominal pain |
...
| Term                    | Simple Meaning                                         |
| ----------------------- | ------------------------------------------------------ |
| **Dialysis**            | Removes excess fluid and wastes when kidneys cannot    |
| **Hemodialysis**        | Blood is filtered through a machine                    |
| **Peritoneal dialysis** | Abdominal lining acts as the filter                    |
| **AV fistula**          | Surgical artery-to-vein connection                     |
| **AV graft**            | Synthetic connection between artery and vein           |
| **Thrill**              | Vibration felt over an access                          |
| **Bruit**               | Swishing sound heard over an access                    |
| **Inflow**              | Dialysate enters the abdomen                           |
| **Dwell**               | Dialysate remains in the abdomen                       |
| **Effluent**            | Used dialysate that drains out                         |
| **Peritonitis**         | Infection of the peritoneal cavity                     |
| **Rejection**           | Immune attack on a transplanted organ                  |
| **Immunosuppressant**   | Medication that reduces immune activity                |
| **Ileal conduit**       | Intestinal segment drains urine into an external pouch |
| **Indiana pouch**       | Internal urine reservoir drained with a catheter       |
| **Stoma**               | Surgically created opening on the abdomen              |
...
1. Dialysis removes wastes, excess fluid, acids, and electrolytes.
2. Dialysis does not replace erythropoietin production.
3. A fistula or graft must have a thrill and bruit.
4. Never use the access arm for blood pressure or blood draws.
5. Obtain weights before and after hemodialysis.
6. Hypotension is a common hemodialysis complication.
7. Cloudy peritoneal effluent suggests peritonitis.
8. Reposition the client when peritoneal drainage is poor.
9. Transplant clients take immunosuppressants for life.
10. Rising creatinine can be an early transplant warning.
11. Mucus is expected in an ileal conduit.
12. A dusky urinary stoma is abnormal.
...
* Do not take blood pressure on a dialysis-access arm.
* Do not ignore an absent thrill or bruit.
* Do not allow a central dialysis catheter dressing to become wet.
* Do not microwave peritoneal dialysate.
* Do not discard cloudy effluent before obtaining a specimen.
* Do not force peritoneal drainage or irrigation.
* Do not stop immunosuppressants independently.
* Do not assume high post-transplant urine output is always harmless.
* Do not collect a culture from a urinary drainage bag.
* Do not treat a dark stoma as an expected finding.
* Do not clamp a nephrostomy or urinary-drainage tube without an order.
...
<div class="cheer-banner">
  💚 These questions are access + infection + fluid balance questions: protect the fistula, inspect the dialysate, monitor the transplanted kidney, and make sure urine can drain. 💚
</div>

---

<div class="page-nav">
  <a href="{{ '/renal-urinary/acute-chronic-kidney-disease.html' | relative_url }}" class="page-nav-back">← Acute & Chronic Kidney Disease</a>
