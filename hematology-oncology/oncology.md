...
- Supporting comfort, quality of life, and patient education
...
Benign tumors are abnormal growths, but they do **not** invade nearby tissue and do **not** metastasize.

<span class="pink-label">Examples</span>
...
Benign tumors may or may not need to be removed. Removal depends on size, location, symptoms, bleeding, pain, function, and whether the growth appears suspicious.

### Example: Fibroid Tumors

Fibroid tumors are benign tumors of the uterus. They do not metastasize, but they can still cause significant symptoms.
...
- Reproductive or urinary symptoms depending on location

Treatment depends on how much the fibroids affect the patient. Some do not require removal. In severe cases, especially with heavy or persistent bleeding, a hysterectomy may be performed.
...
Cancer cells are abnormal cells that divide without normal control.

Cancer cells usually:

- Divide rapidly or continuously
- Ignore apoptosis signals
- Lose the appearance of the original parent cell
- Have a large nuclear-to-cytoplasmic ratio
- Lose normal specialized functions
- Adhere loosely together
- Break away from the main tumor
- Invade nearby structures
- Metastasize
- Continue dividing despite contact with surrounding cells
- May gain or lose chromosomes as malignancy increases
...
Cancer development is called **carcinogenesis** or **oncogenesis**.
...
- Drugs
- Chemicals
- Other growth-enhancing substances
...
A tumor is often detectable when it is about **1 cm** in size or contains about **1 billion cells**.
...
Low-grade tumors look more like normal cells.

High-grade tumors look very different from normal cells and are often poorly differentiated.
...
<span class="pink-label">Assess for</span>
...
<span class="pink-label">Priority findings</span>
...
<span class="pink-label">Nursing interventions</span>
...
## Pediatric Cancer Assessment

Pediatric cancer findings may be obvious or subtle.

<span class="pink-label">Overt findings</span>
...
<span class="pink-label">Covert findings</span>
...
Cancer can affect multiple body systems.

Major consequences include:

- Impaired immune and blood-forming function
...
Nadir is the lowest point of bone marrow activity and blood counts after chemotherapy.

The nadir often occurs around **7 to 10 days** after chemotherapy, but exact timing depends on the medication and regimen.
...
<span class="pink-label">Assess</span>
...
## Class Mention: Myelodysplastic Syndrome

Myelodysplastic syndrome is a bone marrow disorder where the marrow does not make healthy blood cells effectively.

Main risks:

- Low WBCs: infection risk
- Low RBCs: anemia, fatigue, weakness
- Low platelets: bleeding risk

<span class="pink-label">Nursing monitoring</span>
...
<span class="pink-label">Home teaching</span>
...
Cachexia is a wasting syndrome with weight loss, muscle loss, weakness, and poor appetite.
...
<span class="pink-label">Oral care</span>
...
<span class="pink-label">Nursing priorities</span>
...
<span class="pink-label">Concerning findings</span>
...
<span class="pink-label">Assess the affected extremity for</span>
...
- Skin changes in treatment field
- Fatigue
...
## Radiation Field Side Effects Chart
...
- Limit visitors according to policy, such as 30 minutes per day if ordered.
...
<span class="pink-label">Teaching</span>
...
## Radiation Skin and Fatigue Care

Radiation-related skin effects may include:
...
- Do not remove radiation markings unless instructed.
- Plan rest periods for fatigue.

---

## Chemotherapy

Chemotherapy is systemic cancer therapy that targets rapidly dividing cells.
...
- Support surgery or radiation
- Provide palliation

Because chemotherapy affects rapidly dividing cells, it can also affect normal cells in the bone marrow, GI tract, hair follicles, and reproductive system.

---

## Chemotherapy Dosing and Safety

Chemotherapy dosing is often based on body surface area.

<span class="pink-label">Safety priorities</span>

- Accurate height and weight
- Double-checking medication calculations
- Double-checking body surface area
- Verifying orders according to policy
...
- Wearing chemotherapy-approved gloves/PPE when handling chemotherapy medications or body fluids according to facility policy
- Not crushing, splitting, opening, or chewing chemotherapy tablets or capsules
- Clarifying with the oncology team or pharmacist if an oral chemotherapy dose cannot be swallowed whole
...
**ATI/NCLEX Tip:** Feeling better right before the next chemotherapy dose can be expected because the body has had time to recover between cycles.
...
<span class="pink-label">Extravasation findings</span>
...
<span class="pink-label">Nursing safety</span>
...
Before treatment, assess whether fertility preservation has been discussed.

Female patients may discuss egg freezing before treatment.

Male patients who are able to maintain erection and ejaculate may discuss sperm banking before treatment.
...
## Peripheral Neuropathy and Cognitive Changes

Chemotherapy-related peripheral neuropathy may cause:
...
- Fatigue-related thinking changes
...
Hormonal therapy may be used when cancer growth is affected by hormones.

Examples include therapies that block estrogen or androgen effects.
...
<span class="pink-label">Nursing focus</span>
...
<span class="pink-label">Nursing assessment</span>
...
<span class="pink-label">Patient teaching</span>
...
Conditioning is treatment given before transplant. It may include high-dose chemotherapy and/or radiation.

### Engraftment

Engraftment occurs when transplanted stem cells begin to grow, function, and produce new blood cells.

<span class="pink-label">Monitor</span>
...
GVHD can occur after allogeneic transplant when donor immune cells attack recipient tissues.

A mild graft-versus-tumor effect can be helpful, but excessive immune response is dangerous.

GVHD findings may include:
...
- Accurate height and weight
- CBC review close to administration time
- Protocol verification
- Double-checking medication, dose, and body surface area
- IV patency assessment
- Blood return before vesicants
- Emergency medications available according to policy
...
Pediatric radiation nursing care includes:

- Preparing the child and family
- Explaining procedures in age-appropriate language
- Tour or preparation visit when available
- Sedation possibility depending on age and ability to remain still
- Monitoring skin changes
- Monitoring fatigue
- Monitoring bone marrow suppression
- Managing nausea and vomiting
- Monitoring anorexia
- Monitoring mucositis
...
Tumor lysis syndrome occurs when many cancer cells break down quickly and release intracellular contents.
...
Priority concerns include dysrhythmias, seizures, and acute kidney injury.
...
Spinal cord compression may occur when tumor pressure affects the spinal cord.
...
Hypercalcemia can occur when cancer affects bone or calcium regulation.
...
Pediatric oncology nursing includes technical care, emotional support, family-centered care, and developmentally appropriate communication.

Nursing role priorities include:

- Supporting growth and development
- Working with the child and family
- Maintaining technical competence
- Recognizing emotional stress
- Using personal and professional support systems
...
Leukemia is the most common cancer in children under age 15.

It involves uncontrolled production of immature white blood cells in blood-forming organs.

Findings may include:

- High or low WBC count for age
- Anemia
...
Treatment commonly includes combination chemotherapy phases:

- Induction
- CNS prophylaxis
- Maintenance
- Reinduction if relapse occurs
...
- Bleeding precautions
- Avoiding active routine immunizations during immunosuppression
...
Brain tumors are the second most common pediatric neoplasm and the most common solid tumor in children.

They often occur in the lower brain, cerebellum, or brainstem.
...
Management may include surgery, shunt placement, antiseizure medications, radiation, and chemotherapy.

<span class="pink-label">Postoperative nursing care</span>
...
Malignant lymphomas are common pediatric cancers and include non-Hodgkin lymphoma and Hodgkin lymphoma.
...
- Weight loss
- Ascites
- Painless enlarged cervical or axillary nodes
- Cough
- Respiratory distress pattern
- Tracheal deviation pattern with mediastinal disease
...
Neuroblastoma is a solid tumor of infants and children that arises from neural crest cells, the sympathetic nervous system, or adrenal medulla.
...
Prognosis is generally better when diagnosed before age 1.

---

## Osteosarcoma

Osteosarcoma is a primary malignant bone tumor often found in long bones.
...
- Symptoms that may resemble injury
- Pain lessened by flexing
- Pathologic fracture risk
- Lung metastasis concern

Management may include radical resection or amputation.

<span class="pink-label">Nursing priorities</span>

- Body image support
- Pain management
- Stump dressing assessment
- Vital signs
...
Ewing sarcoma is a malignant tumor of the bone marrow, often affecting long bones in older school-age children.
...
Rhabdomyosarcoma is a malignancy of muscle or striated tissue.

It may occur near the orbit or other soft tissue areas.

Symptoms depend on location.

Management may include chemotherapy, radiation, and surgery.
...
Wilms tumor, also called nephroblastoma, is a kidney tumor of early childhood.

It often occurs before age 3.
...
Retinoblastoma is a malignant tumor of the neural retina and occurs in children.

Findings may include:

- White reflex
- Lack of red-eye reflex in photos
- Strabismus
...
Management may include enucleation, radiation, cryotherapy, or chemotherapy.

Psychosocial support is important for the child and family.

---

## Survivorship

Survivorship care focuses on follow-up, recurrence monitoring, long-term effects, health promotion, and quality of life.
...
Cancer pain may be caused by tumor pressure, bone involvement, nerve involvement, treatment effects, surgery, mucositis, or procedures.
...
End-of-life care focuses on comfort, dignity, symptom relief, family support, and respect for patient goals.

Possible signs of approaching death include:

- Cool or mottled skin
- Cyanosis
- Decreased level of consciousness
- Hearing may remain intact
- Irregular breathing
- Cheyne-Stokes respirations
- Gurgling or death rattle pattern
- Decreased movement
- Decreased intake
- Weak pulse
- Changes in urine output
- Restlessness or groaning that may require pain assessment
...
<span class="pink-label">Nursing care focuses on</span>
...
<span class="pink-label">Family education</span>
...
RN responsibilities usually include:

- Initial assessment
- Unstable patient assessment
- Chemotherapy verification according to policy
- Blood product monitoring according to policy
- Education requiring nursing judgment
- Clinical judgment decisions
- Care planning
- Provider communication

LPN/VN responsibilities may include stable patient care, focused data collection, medication administration within scope, and reinforcing education depending on state law and facility policy.

Assistive personnel may help with routine tasks such as:
